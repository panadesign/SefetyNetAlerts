...
public interface PersonManager {
	 ...
	 * @return using firstName and lastName in parameters, the person with the same firstName and lastName, and a list of persons with the same lastName.
	 * return for each person : firstName, lastName, email, age, list of medications and list of allergies
	 */
	 ...
	 * @return This method return a map of persons by address for flood alert
	 * return by address list of persons with their firstName, lastName, phone, age, list of medications and list of allergies
	 */
